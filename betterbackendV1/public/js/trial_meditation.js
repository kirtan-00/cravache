  ...
  function injectCSS(){
    ...
    st.textContent = [
      ...
      '#med-launcher{position:absolute;left:14px;bottom:172px;z-index:70;',
        ...
        'font-family:"Silkscreen",monospace;font-size:11px;line-height:1;',
        'text-transform:uppercase;letter-spacing:1px;',
        'box-shadow:inset 0 2px 0 rgba(159,232,255,.12),inset 0 -3px 0 rgba(0,0,0,.5),2px 2px 0 #000;}',
      '#med-launcher .med-ico{font-size:20px;line-height:1;}',
      '#med-launcher:hover{background:var(--navy-d,#16203a);color:var(--teal,#9fe8ff);}',
      '#med-launcher:active{transform:translate(2px,2px);',
        'box-shadow:inset 0 2px 0 rgba(159,232,255,.12),inset 0 -3px 0 rgba(0,0,0,.5),0 0 0 #000;}',
      '#med-launcher[disabled]{opacity:.45;cursor:not-allowed;',
        'background:var(--navy-dd,#0d1426);color:var(--paper,#f4e8cf);transform:none;',
        'box-shadow:inset 0 2px 0 rgba(159,232,255,.12),inset 0 -3px 0 rgba(0,0,0,.5),2px 2px 0 #000;}',
      // breathing overlay
